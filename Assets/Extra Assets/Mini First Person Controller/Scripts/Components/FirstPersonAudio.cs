...
public class FirstPersonAudio : MonoBehaviour
{
    ...
    private void Start() {
        // CUSTOM METHOD FOR ADJUSTING AUDIO!
        stepAudio.volume = GameManager.Instance.AudioEffectVolume;
        runningAudio.volume = GameManager.Instance.AudioEffectVolume;
        landingAudio.volume = GameManager.Instance.AudioEffectVolume;
        jumpAudio.volume = GameManager.Instance.AudioEffectVolume;
    }
